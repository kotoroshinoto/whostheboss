#!/usr/bin/env python
import click
from scribe_classifier.data.scribe.not_implemented.util.training_set_defs import TrainingSetMap, generate_training_set_defs_from_path, generate_training_set
