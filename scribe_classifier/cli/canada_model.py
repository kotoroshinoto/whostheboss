...
@canada_model_cli.command(name="dataset")
...
def generate_data_set(target_level, example_file, train_filepath, valid_filepath, test_filepath, valid_prop, test_prop):
    ...
    train, valid, test = all_titles.split_data_valid_train_test(test_split=test_prop, valid_split=valid_prop, target_level=target_level)
