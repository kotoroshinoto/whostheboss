...
from scribe_classifier.data.canada.NOCdb.readers import AllCodes, TitleSet
from scribe_classifier.data.canada.NOCdb.models import SimpleModel, MultiStepModel
...
@click.option('--target', type=click.IntRange(1, 4), default=2, help="train against this code abstraction level")
def simple(model_filepath, train_filepath, target):
