...
#level 1
python -m scribe_classifier.cli.main model neural_net test 1 \
--emptyset NA \
...
#level 2
python -m scribe_classifier.cli.main model neural_net test 2 \
--emptyset NA \
...
#level 3
python -m scribe_classifier.cli.main model neural_net test 3 \
--emptyset NA \
...
#level 4
python -m scribe_classifier.cli.main model neural_net test 4 \
--emptyset NA \
